...
- 준수 사항:
  ...
  - **버전 동기화 (Triple Sync)**: 패치 또는 기능 추가 시 `sw.js`, `manifest.webmanifest`, `app.js`의 버전 정보를 반드시 일치시켜야 합니다. ([[Version_Management_Principles.md]] 참조)
  ...
  - Modern Hybrid 전략 준수 (Vite/TS/Tailwind 활용 및 레거시 Native Modules 호환성 유지)
