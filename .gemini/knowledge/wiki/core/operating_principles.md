...
description: "Operating Principles reference documentation."
...
- **현대적 DX (Modern Hybrid)**: 순수 CSS/JS의 간결함을 지향(No-build Oriented)하되, 타입 안정성과 유지보수성을 위해 Vite, TS, Tailwind v4 인프라를 적극 활용합니다.
...
- **버전 관리**: [Version_Management_Principles](./version_management_principles.md) 문서에 정의된 체계를 따르며, GitHub Actions를 통한 자동 배포를 적극 활용합니다.
...
---
*연결 노드:* [Project_History](../phases/project_history.md), [Architecture_Reference](./architecture_reference.md)
