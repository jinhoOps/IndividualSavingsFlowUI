...
description: "Architecture Reference reference documentation."
...
- **Branded Types**: `Won`, `ManWon` 타입을 구분하여 산술 연산 시 단위 실수를 방지합니다. ([Data_Model_Reference](./data_model_reference.md) 참조)
...
---
*연결 노드:* [Data_Model_Reference](./data_model_reference.md), [UI_Standards_Reference](./ui_standards_reference.md), [Operating_Principles](./operating_principles.md)
