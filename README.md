...
- **Portfolio**: 최신 Main 투자금을 자유 이름 투자 대상과 현금에 배분하고, 안정 비중과 비례 목록을 먼저 보여주는 현재 제품입니다.
...
최신 Main 투자금을 직접 읽어 최대 10개 자유 이름 투자 대상과 현금에 배분합니다. 금액 또는 비율로 편집하고, 결과에서는 원화 금액을 기본으로 숨긴 채 안정 비중과 가장 큰 배분 대상을 요약한 뒤 이름·비율·비례 막대 목록을 보여줍니다. 관리 메뉴에서 전체 금액 표시와 비율순·입력순 정렬을 바꿀 수 있습니다. Portfolio는 적용 계획 하나와 초안을 저장하며 Main을 수정하지 않습니다. 계좌, 시세, 수익률과 복수 계획은 현재 범위가 아닙니다.
