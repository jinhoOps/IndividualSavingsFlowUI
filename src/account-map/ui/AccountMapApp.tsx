...
export function AccountMapApp({ repositories }: { repositories?: AccountMapRepositories } = {}): JSX.Element {
  ...
  const management = <AccountMapManagementMenu hasMap={state.mode === 'map'} />;
