export const EXPENSE_ITEMS = [
  ...
  { id: 'maintenance', label: '공용관리비', question: '수도·전기·가스를 뺀 관리비는 얼마인가요?', hint: '공용관리비(일반관리비)만 입력해주세요. 수도·전기·가스요금은 고지서에 함께 나와도 빼고, 뒤의 공과금에서 따로 입력해요.', example: '예: 고지서 20만 원이 공용관리비 12만 원 + 사용요금 8만 원이라면, 여기에는 12만 원만 입력해요.', group: 'fixed', target: 'housing' },
  ...
  { id: 'utilities', label: '공과금', question: '수도·전기·가스 등 공과금은 얼마인가요?', hint: '전기·도시가스·상하수도요금과 소득세·재산세·자동차세 등을 합쳐주세요. 관리비 고지서에 포함된 사용요금도 여기에 입력해요. 급여에서 이미 공제된 세금은 제외해주세요.', example: '앞의 예시에서 뺀 사용요금 8만 원은 여기에 입력해요. 공용관리비 12만 원은 다시 더하지 않아요.', group: 'variable', target: 'housing' },
