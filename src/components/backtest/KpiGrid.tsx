  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-md">
      {results.map(({ asset, result }) => (
        <div key={asset.id} className="panel backdrop-blur-md transition-all hover:shadow-lg">
          ...
          <div className="space-y-sm">
            <div>
              ...
              <div className="text-lg font-black text-ink">
                {(result.finalValue / 10000).toLocaleString()} <span className="text-xs font-normal text-muted">만원</span>
              </div>
            </div>
