...
> **기간 예외 보존:** 월 복리·명목/실질 계산과 Main 읽기 전용 경계. 최신 제품·UI·저장 세대는 [문서 안내](../README.md)와 PRD를 우선한다. 아래에는 설계 당시의 기록도 포함된다.
...
- 기간: 5년 (2026-09-11 새 초안 기본값 변경; 저장된 기간 유지)
- 투자 연 기대수익률: 9%
- 기준금리: 3.0% (2026-09-11 새 초안 기본값 변경; 기존 저장값 유지)
- 물가상승률 차이: -0.25%p
- 물가상승률: 2.75%
- 금액 표시: 명목금액
