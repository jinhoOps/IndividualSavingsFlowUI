...
> 2026-09-10 도크 갱신: 사용자가 아이콘만 표시하는 미니멀한 구성을 유지하며 작은 도크와 선택 반응을 적용하도록 승인했다. 이 문서의 전체 폭·오른쪽 끝 정렬·캡슐 미사용에 관한 시각 배치는 [DESIGN의 App Launcher](../../../DESIGN.md#app-launcher) 계약으로 대체한다. navigation과 관리 group의 의미적 분리, URL 탐색, tooltip·long-press·overflow·focus 계약은 유지한다.

> 2026-09-10 메뉴 정리: 사용자 승인에 따라 아래의 `앱 아이콘 안내` 및 정상 백업 UI 계약은 폐기한다. 앱별 설정과 계정·복구 항목은 [현재 DESIGN](../../../DESIGN.md#app-launcher) 및 [검증 기록](../evidence/2026-09-10-management-menu-cleanup.md)을 따른다. 개별 아이콘 tooltip·long-press는 유지한다.
