...
### 배당 시뮬레이션 가정 설정 프리셋 (User Request)
- **D-05:** 배당 시뮬레이션 가정(기대 배당수익률, 배당 성장률, 주가 상승률) 설정 시, 사용자가 대표적인 ETF 조합을 쉽게 선택할 수 있도록 다음 3가지 프리셋 가이드를 제공한다.
  - 단일 100% (예: SCHD)
  - SCHD + QQQI (1:1)
  - QQQI + JEPI (7:3)
  - 3종 조합 SCHD + JEPI + QQQI (40:30:30)
- **D-06:** 프리셋을 선택하더라도, 현재 상태처럼 사용자가 세부 파라미터를 수동으로 조절할 수 있는 기능은 반드시 유지한다.
