...
## Phase 7: 백테스트 시뮬레이터 대시보드 (Step 4 - Issue #7, v0.9.7 완료)
...
- [x] 07-03-PLAN.md — KPI 요약 카드 및 최종 통합 검증 (v0.9.7 완료)

---

## Phase 8: 지출 데이터 과거 비교 분석 (Issue #4 - v0.9.8 완료)

**Goal:** `DataHub`에 저장된 이전 스냅샷 데이터를 불러와 현재 지출과 카테고리별로 비교하는 시각화 도구를 제공한다.

**Plans:**
- [x] 08-01-PLAN.md — 스냅샷 비교 엔진 및 막대 그래프 시각화 구현 (v0.9.8)
