...
- Main 저장 진행은 600ms 지연 후 편집 맥락의 작은 오버레이로 표시합니다. 버튼과 안내문 크기·주변 레이아웃은 유지하고 Anime.js로 짧게 등장하며 reduced-motion에서는 즉시 표시합니다. 금액 행과 도우미 제목에는 마법지팡이 아이콘을 표시하지 않습니다.
